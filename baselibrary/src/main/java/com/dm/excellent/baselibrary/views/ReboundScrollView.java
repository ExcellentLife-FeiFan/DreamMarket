...
public class ReboundScrollView extends ScrollView {
    ...
    public interface OnComeToBottomListener {
        void OnComeToBottomListener();
    }

    public OnComeToBottomListener onComeToBottomListener;

    public void setOnComeToBottomListener(OnComeToBottomListener onComeToBottomListener) {
        this.onComeToBottomListener = onComeToBottomListener;
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (isBottom) {
                    if (null != onComeToBottomListener) {
//                        Log.e("--ReboundScrollView--", "OnComeToBottomListener");
                        onComeToBottomListener.OnComeToBottomListener();
                    }
...
//                    Log.e("--ReboundScrollView--offset", offset + "");
//                    Log.e("--ReboundScrollView--isBottom", isBottom + "");
                    // 随着手指的移动而移动布局
